  ...
  const FieldModules = () => {
    ...
    const updateData = useCallback(
      ...
      [checkboxState, detailsKey, detailsValue]
    );
        ...
        return existingModules.map((mod) => {
          if (mod.name === (module ? module.name : "")) {
              ...
              if (submodules.some((newSub) => newSub.name === sub.name)) {
                return {
                  ...
                  details: checkboxState.hasDetails
                    ? [...(sub.details || []), { [detailsKey]: detailsValue }]
                    : sub.details,
                };
              }
              return sub;
            ...
            return {
              ...
              details: checkboxState.hasDetails
                ? [...(mod.details || []), { [detailsKey]: detailsValue }]
                : mod.details,
            };
          }
          return mod;
    ...
    const handleCheckboxChange = (e) => {
      ...
      // Ensure "hasDetails" is not added as a direct key in the output
      if (selectedHotel && selectedModule && name !== "hasDetails") {
        updateData(
          selectedHotel,
          selectedModule,
          selectedSubmodules,
          name, // Only update other fields like 'isActive', 'isDisabled', etc.
          checked ? "True" : "False"
        );
      }
    };
   ...
   const handleDetailsValueSelect = (e) => {
     ...
     if (selectedHotel) {
       updateData(
         ...
         selectedKeys,
         null,
         { key: detailsKey, value: selectedValue } // This will only add to the current level
       );
     }
   };
